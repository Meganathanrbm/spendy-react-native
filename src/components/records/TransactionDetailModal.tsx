          ...
          <>
            ...
            >
              {isExpense && (
                <>
                  ...
                  <Row
                    label="Account"
                    value={accountName(tx.accountId)}
                    colors={colors}
                  />
                  <Sep color={colors.border} />
                  <Row
                  ...
                  {hasNotes && (
                    <>
                      <Sep color={colors.border} />
                      <Row label="Notes" value={tx.title} colors={colors} />
                    </>
                  )}
              ...
              {isTransfer && (
                <>
                  <Row
                    label="From"
                    value={accountName(tx.fromAccountId ?? tx.accountId)}
                    colors={colors}
                  />
                  <Sep color={colors.border} />
                  <Row
                    label="To"
                    value={accountName(tx.toAccountId)}
                    colors={colors}
                  />
                  <Sep color={colors.border} />
                  <Row
            ...
            <View style={styles.actions}>
              ...
              <TouchableOpacity
                style={[
                  styles.btn,
                  { backgroundColor: colors.expenseAccent + "1A" },
                ]}
...
function Row({
  ...
  return (
    <View style={styles.row}>
      ...
      {smsTag ? (
        <View
          style={[styles.smsTag, { backgroundColor: colors.surfaceElevated }]}
        >
          <Text style={[styles.smsTagText, { color: colors.textSecondary }]}>
            {value}
          </Text>
        </View>
      ) : (
